...
/*   Updated: 2023/09/15 12:13:51 by admansar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm ()
	: name("a random"), signed_at_constrution(false), grade_to_sign(1), grade_to_execute(1), reason ("not signed yet")
{
}

AForm::AForm (std::string name, bool sign, int gts, int gte)
	: name(name), signed_at_constrution(sign), grade_to_sign(gts), grade_to_execute(gte), reason ("")
{}
